# 1. Development Mode: <br/>
  ...
  Then you hold crtl + click on the link in the cmd or powershell (Ex: http://localhost:3000 or http://localhost:3001) -->The website will automatically open on the web browser.
