1. Development Mode:
  Navigate to your project directory: Open your terminal or command prompt and use the cd command to navigate to the root directory of your Next.js project.
  Code:
      cd your-nextjs-app
  ...
  Then you hold crtl + click on the link (Ex: http://localhost:3000 or http://localhost:3001).The website will automatically open on the web browser.
